...
circumcircle :: (Eq a, Floating a, Real a) => Triangle2 a -> Circle2 a
circumcircle t = (center, realToFrac radius)
    where center = circumcenter t
          radius = sqrt $ squaredDistancePointLine2 center (segmentToLine2 $ Segment2 (p1 t) (p2 t))
...
-- | Determines if a point is inside the circumcircle of a triangle.
isInsideCircumcircle2 :: (Eq a, Fractional a, Floating a, Real a) => Triangle2 a -> Point2 a -> Bool
isInsideCircumcircle2 t p = isInsideCircle2 p (circumcircle t)
